...
API_HASH = environ.get('API_HASH', '79e5caa103a9e9fb0183390b4800845d')nn
OWNER_ID = environ.get('OWNER_ID', '6283322330')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6283322330 5115691197').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002294126424').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002294126424') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002294126424') # request channel id ( make sure bot is admin )
...
AI_LOGS = int(environ.get("AI_LOGS", "-1002294126424")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of Bot ]
...
DUMP_CHNL = int(environ.get('DUMP_CHNL', '-1002294126424'))
